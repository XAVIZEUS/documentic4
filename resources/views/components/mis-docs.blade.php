...
<div class="table-responsive border rounded p-3">
    <table class="table table-sm table-bordered  table-hover text-center " id="todo" width="100%" cellspacing="0">
        <thead>
            <tr>
        ...
        <tbody>
            @foreach ($asignados as $asignado)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm text-primary" title="Editar" data-toggle="modal" data-target="#editarHR"><i
                                class="fas fa-pen-alt"></i> </a>

                        <a href="" target="_blank" class="btn btn-sm text-info" title="Descargar">
